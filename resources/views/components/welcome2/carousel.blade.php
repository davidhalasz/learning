<div class="bg-[#0F335B] md:pt-8 lg:pt-12 relative h-[570px] md:h-[800px] lg:h-[700px] overflow-hidden" x-data="{
        activeSlide: 0,
        nextSlide() {
                    ...
                    <div x-show="activeSlide === {{ $index }}" class="absolute inset-0">
                        <div class="w-full flex flex-col lg:flex-row gap-4">
                            <div class="w-full md:w-full lg:w-1/2 lg:h-[500px] px-8 md:px-0 mb-4 lg:mb-0 mt-4 lg:pt-0">
                                <div class="w-full text-center lg:text-left flex flex-col lg:mt-[190px]"> 
                            ...
                            <div x-show="activeSlide === 0" class="w-full md:w-[640px] relative h-[200px] md:h-[400px] ml-10 lg:ml-0">
                            ...
                            <div x-show="activeSlide === 1" class="w-full md:w-[640px] relative h-[200px] md:h-[400px]  ml-10 lg:ml-0">
                                <div class="absolute w-full h-full flex flex-row">
                                    <div class="w-2/12"></div>
                            ...
                            <div x-show="activeSlide === 2" class="w-full md:w-[640px] relative h-[200px] md:h-[400px]  ml-10 lg:ml-0">
                                <div class="absolute w-full h-full flex flex-row">
