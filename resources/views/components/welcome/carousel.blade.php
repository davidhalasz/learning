<div class="bg-[#0F335B] relative heroheight overflow-hidden h-full tracking-wide" x-data="{
    activeSlide: 0,
    nextSlide() {
        ...
        <div class="relative flex h-full justify-center">
            @foreach ($slides as $index => $slide)
                <div x-show="activeSlide === {{ $index }}" class="absolute inset-0 flex h-full justify-center">
                    <div class="w-full flex flex-col lg:flex-row gap-4 h-full justify-center items-center px-10 lg:px-0">
                        ...
                        <div class="w-full md:w-full lg:w-1/2  px-8 md:px-0 mb-4 lg:mb-0 lg:pt-0">
                            <div class="z-30 w-full text-center lg:text-left flex flex-col flex justify-center items-center lg:items-start"> 
                               ...
                               @endphp
                                <div class="textScale1 text-2xl font-extrabold mb-1 w-fit">
                                    <span class="bg-clip-text text-transparent rounded-md py-1 px-2 bg-gradient-to-r from-white to-white">
                                        {{ $words[0] }}
                                    </span>
                                </div>
                                <div class="textScale2 text-2xl font-extrabold mb-1 w-fit">
                                    <span class="bg-clip-text text-transparent rounded-md py-1 px-2 bg-gradient-to-r from-white to-white">
                                        {{ $words[1] }}
                                    </span>
                                </div>
                                <div class="textScale3 text-2xl font-extrabold mb-1 w-fit">
                                    <span class="bg-clip-text text-transparent rounded-md py-1 px-2 bg-gradient-to-r from-white to-white">
                                        {{ $words[2] }}
                                    </span>
                                </div>
                        ...
                        <div x-show="activeSlide === 1" class="w-full md:w-[640px] relative h-[200px] md:h-[650px]  ml-10 lg:ml-0">
                            <div class="absolute w-full h-full flex flex-row">
                                <div class="w-2/12"></div>
                                <img class="move1 w-5/12 aspect-[4/3] h-fit object-cover rounded-xl mt-4 -ml-20 lg:-ml-32"
                                        src="{{ asset('images/' . $slide['images'][0]) }}" alt="">
                                <div class="w-5/12"></div>
                            </div>
                            <div class="absolute w-full h-full flex flex-row">
                        ...
                        <div x-show="activeSlide === 2" class="w-full md:w-[640px] relative h-[200px] md:h-[650px]  ml-10 lg:ml-0">
                            <div class="absolute w-full h-full flex flex-row">
                                ...
                                <img class="move1 w-6/12 aspect-[6/4] h-fit object-cover rounded-xl mt-8 -ml-14 md:-ml-20 lg:-ml-32"
                                        src="{{ asset('images/' . $slide['images'][0]) }}" alt="">
                                <div class="w-5/12"></div>
                            </div>
                            <div class="absolute w-full h-full flex flex-row">
