<div class="w-full bg-gray-200 py-10">
    <div id="uzletviteliTanacsadas" class="container mx-auto bg-white shadow-md py-20 rounded-[50px]">
        ...
        <div class="flex flex-col mt-4 md:mt-8">
            <div class="flex flex-row gap-10 px-4 md:px-24">
                <div class="basis-3/12 w-full   flex justify-end items-center" >
                ...
                <div class="basis-9/12 flex items-center justify-start">
                    <div>
                        <p class="md:text-lg mb-2">Hiszünk abban, hogy egy projekt legfontosabb ciklusa az előkészítés,
                        ...
                        <p class="md:text-lg mb-2">Célunk, hogy szakértői közreműködésünkkel legmagasabb szinten
...
<div class="w-full bg-[#0F335B] py-10">
    <div id="businessCoaching" class="container mx-auto bg-gray-100 shadow-md py-20 rounded-[50px]">
        ...
        <div class="flex flex-col mt-4 md:mt-8">
            <div class="flex flex-row gap-10 px-4 md:px-24">
                <div class="basis-9/12 flex items-center justify-start">
                    <div>
                        <p class="md:text-lg mb-2">A business coaching nemcsak a vezetők egyéni fejlődését segíti elő,
                        ...
                        <p class="md:text-lg mb-2">A coaching folyamatán keresztül a vezetők képesek lesznek átlátni a
                ...
                <div class="basis-3/12 w-full  flex justify-end"
                    >
                    <img class="w-full h-full object-cover rounded-xl dynamic-height shadow-2xl" id="dynamic-height" src="{{ asset('images/kepzes5.jpg') }}"
                        alt="" />
                </div>
            </div>
        </div>
...
<div class="w-full bg-gray-200 md:py-10">
    <div id="felnottkepzes" class="container mx-auto py-14 md:py-20 rounded-[50px] text-gray-100 px-4 md:px-0">
        <h1 class="text-center font-bold text-3xl md:text-6xl text-black">Felnőttképzés</h1>
        <div class="w-full md:w-[450px]  md:h-[450px] mx-auto mt-10 py-8 lg:py-4 rounded-2xl gradientBg2 shadow-lg">
            <div class="w-full h-full flex flex-col">
                <div class="h-fit m-auto">
                    ...
                    <a href="#"
                        class="p-4 font-bold text-emerald-100 flex items-center text-lg hover:text-blue-300">
