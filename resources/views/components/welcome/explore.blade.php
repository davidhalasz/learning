<div class="w-full bg-gray-300 py-10">
    <div id="uzletviteliTanacsadas" class="container mx-auto bg-white py-20 rounded-[50px]">
        ...
        <div class="flex justify-center py-10 px-4">
            <p class="text-center text-lg md:w-[650px]">Egy projekt sikere sok mindenen múlik. Az
                előkészítés, megvalósítás és monitorozás egyaránt kulcsfontosságú ciklusa egy projekt eredményes
                megvalósításának.</p>
        </div>

        <div class="flex flex-col mt-4">
            <div class="flex flex-col md:flex-row gap-10 lg:gap-10 px-4 md:px-24">
                <div class="w-1/3 mx-auto md:basis-2/12 items-center flex justify-end">
                ...
                <div class="basis-10/12 flex items-center justify-start">
                    <div>
                        <h2 class="text-lg font-bold py-2">Előkészítés</h2>
            ...
            <div class="flex flex-col-reverse md:flex-row gap-10 lg:gap-10 px-4 md:px-24 mt-10 lg:mt-0">
                <div class="basis-10/12 flex items-center justify-start">
                    <div>
                        <h2 class="text-lg font-bold py-2">Tanácsadás</h2>
            ...
            <div class="flex flex-col md:flex-row gap-10 lg:gap-10 px-4 md:px-24 mt-10 lg:mt-0">
                <div class="w-1/3 mx-auto md:basis-2/12 flex justify-end items-center">
                ...
                <div class="basis-10/12 flex items-center justify-start">
                    <div>
                        <h2 class="text-lg font-bold py-2">Egyedi problémamegoldás</h2>
...
<div class="w-full bg-[#0F335B] py-10">
    <div id="businessCoaching" class="container mx-auto linear-bg-2 py-20 rounded-[50px]">
        ...
        <div class="flex justify-center py-10 px-4">
            <p class="text-center text-lg md:w-[650px]">A sikeres vezetőknek kell rendelkezniük a
        ...
        <div class="flex flex-col mt-4">
            <div class="flex flex-col md:flex-row gap-10 lg:gap-10 px-4 md:px-24">
                <div class="w-1/3 mx-auto md:basis-2/12 w-full flex justify-end">
                    <img id="dynamic-height" class="w-full h-full object-cover rounded-xl dynamic-height shadow-2xl" src="{{ asset('images/kepzes5.jpg') }}"
                        alt="" />
                </div>
                <div class="basis-10/12 flex items-center justify-start">
                    <div>
                        <h2 class="text-lg font-bold py-2">Egyéni fejlődés és szervezetfejlesztés</h2>
            ...
            <div class="flex flex-col-reverse md:flex-row gap-10 lg:gap-10 px-4 md:px-24 mt-10 lg:mt-0">
                <div class="basis-10/12 flex items-center justify-start">
                    <div>
                        <h2 class="text-lg font-bold py-2">Környezetváltozások kezelése</h2>
            ...
            <div class="flex flex-col md:flex-row gap-10 lg:gap-10 px-4 md:px-24 mt-10 lg:mt-0">
                ...
                <div class="basis-10/12 flex items-center justify-start">
                    <div>
                        <h2 class="text-lg font-bold py-2">Teljesítményfejlesztés és növekedés</h2>
