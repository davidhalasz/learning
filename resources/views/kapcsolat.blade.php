<x-guest-layout>
    <div class="min-h-screen container mx-auto py-10 md:py-20">
        <h1 class="text-2xl md:text-4xl font-bold text-center pb-10">Kapcsolat</h1>
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 px-10 md:px-24">
            <div class="w-full dynamic-height rounded-xl bg-[#eef2f5] flex flex-col justify-center items-center p-8">
            ...
            <div class="md:col-span-2 lg:col-span-3 rounded-xl bg-[#eef2f5] md:h-80 overflow-hidden flex flex-col md:flex-row">
